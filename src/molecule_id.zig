    ...
    enum(u16) {
        ...
        pub inline fn molecule(this: MoleculeId) Molecule {
            return switch (this) {
                ...
                .barium_dichloride => .{ .weight = 208.233, .density = 3.86, .log_p = -3.0, .hbd = 0, .hba = 0, .psa = 0, .state = .solid, .boiling_point = 1833.0, .melting_point = 1235.0, .water_solubility = 1.5, .delta_hf = -858.56, .delta_hvap = 250.0, .delta_hfus = 22.0, .hildebrand = 25.0, .heat_capacity = 75.1, .color = .white, .color_intensity = 0.8, .odor = .none, .odor_intensity = 0.0, .bulk_modulus = 15.0e9 },
                .barium_ion => .{ .weight = 137.327, .density = 1.0, .fully_protonated_charge = 2, .log_p = -5.0, .hbd = 0, .hba = 0, .state = .liquid, .water_solubility = null, .delta_hf = -537.6, .heat_capacity = 30.0, .is_ion = true, .partial_molar_volume = -12.0 },
                .barium_sulfate => .{ .weight = 233.39, .density = 4.49, .log_p = -3.0, .hbd = 0, .hba = 4, .psa = 66.0, .state = .solid, .boiling_point = 1870.0, .melting_point = 1620.0, .water_solubility = 0.0000045, .delta_hf = -1473.2, .delta_hvap = 300.0, .delta_hfus = 38.0, .hildebrand = 25.0, .heat_capacity = 101.6, .color = .white, .color_intensity = 0.9, .odor = .none, .odor_intensity = 0.0, .bulk_modulus = 30.0e9 },
                ...
                .calcium_ion => .{ .weight = 40.078, .density = 1.55, .fully_protonated_charge = 2, .log_p = -2.5, .hbd = 0, .hba = 0, .state = .solid, .melting_point = 1115.0, .boiling_point = 1757.0, .water_solubility = null, .delta_hf = -542.8, .heat_capacity = 25.0, .is_ion = true, .partial_molar_volume = -17.8 },
                ...
                .disodium_sulfate => .{ .weight = 142.042, .density = 2.66, .log_p = -3.0, .hbd = 0, .hba = 4, .psa = 66.0, .state = .solid, .boiling_point = 1700.0, .melting_point = 1157.0, .water_solubility = 1.97, .delta_hf = -1387.08, .delta_hvap = 230.0, .delta_hfus = 24.0, .hildebrand = 25.0, .heat_capacity = 128.4, .color = .white, .color_intensity = 0.8, .odor = .none, .odor_intensity = 0.0, .bulk_modulus = 15.0e9 },
                ...
                .hydrogen_ion => .{ .weight = 1.008, .density = 1.0, .fully_protonated_charge = 1, .log_p = -6.0, .hbd = 1, .hba = 0, .state = .gas, .water_solubility = null, .delta_hf = 0.0, .heat_capacity = 10.0, .is_ion = true, .partial_molar_volume = 0.0 },
                ...
                .sodium_ion => .{ .weight = 22.990, .density = 0.968, .fully_protonated_charge = 1, .log_p = -3.5, .hbd = 0, .hba = 0, .psa = 0, .state = .liquid, .boiling_point = null, .melting_point = null, .water_solubility = null, .delta_hf = -240.34, .hildebrand = null, .protein_binding = 0.0, .gas_lipid_partition = 0.0, .delta_hvap = null, .heat_capacity = 25.0, .color = .transparent, .color_intensity = 0.0, .odor = .none, .odor_intensity = 0.0, .is_ion = true, .partial_molar_volume = -6.7 },
                .sulfate_ion => .{ .weight = 96.06, .density = 1.0, .fully_protonated_charge = -1, .pka = &.{1.99}, .log_p = -4.0, .hbd = 0, .hba = 4, .state = .liquid, .water_solubility = null, .delta_hf = -909.3, .heat_capacity = 50.0, .is_ion = true, .partial_molar_volume = 14.0 },
            };
        }
