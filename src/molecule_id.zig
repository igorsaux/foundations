...
pub const MoleculeId = if (!builtin.is_test and @hasDecl(root, "MoleculeId"))
    root.MoleculeId
else
    enum(u16) {
        ...
        pub inline fn getViscosity(this: MoleculeId, temperature: f64) f64 {
            return this.molecule().getViscosity(temperature);
        }
        ...
        pub inline fn getDisplayName(this: MoleculeId) []const u8 {
            return switch (this) {
                ...
                .argon => "Argon",
                .azane => "Ammonia",
                .barium_dichloride => "Barium Dichloride",
                .barium_ion => "Ba+",
                ...
                .disodium_sulfate => "Disodium Sulfate",
                .ethanol => "Ethanol",
                .graphite => "Graphite",
        ...
        pub inline fn molecule(this: MoleculeId) Molecule {
            return switch (this) {
                .acetate_ion => .{ .weight = 59.044, .density = 1.0, .fully_protonated_charge = 0, .pka = &.{4.76}, .log_p = -3.72, .hbd = 0, .hba = 2, .state = .solid, .water_solubility = 5.7, .delta_hf = -486.0, .heat_capacity = 80.0, .is_ion = true, .partial_molar_volume = 45.4 },
                .acetic_acid => .{ .weight = 60.052, .density = 1.049, .pka = &.{4.76}, .log_p = -0.17, .hbd = 1, .hba = 2, .state = .liquid, .boiling_point = 391.1, .melting_point = 289.8, .delta_hf = -484.5, .delta_hvap = 23.7, .delta_hfus = 11.73, .hildebrand = 20.7, .heat_capacity = 123.1, .odor = .acrid, .odor_intensity = 0.7, .viscosity = 1.22e-3 },
                .argon => .{ .weight = 39.948, .density = 0.001633, .log_p = 0.0, .hbd = 0, .state = .gas, .boiling_point = 87.30, .melting_point = 83.81, .water_solubility = 0.0014, .delta_hf = 0.0, .delta_hvap = 6.45, .delta_hfus = 1.18, .heat_capacity = 20.79, .partial_molar_volume = 32.0 },
                .azane => .{ .weight = 17.031, .density = 0.73, .log_p = -1.38, .hbd = 3, .hba = 1, .state = .gas, .boiling_point = 239.8, .melting_point = 195.4, .delta_hf = -45.9, .delta_hvap = 23.35, .delta_hfus = 5.66, .heat_capacity = 35.06, .odor = .ammoniacal, .odor_intensity = 1.0, .partial_molar_volume = 24.6 },
                .barium_dichloride => .{ .weight = 208.233, .density = 3.86, .log_p = -3.0, .hbd = 0, .psa = 0, .state = .solid, .boiling_point = 1833.0, .melting_point = 1235.0, .water_solubility = 1.5, .delta_hf = -858.56, .delta_hvap = 250.0, .delta_hfus = 22.0, .hildebrand = 25.0, .heat_capacity = 75.1, .color = .white, .color_intensity = 0.8, .bulk_modulus = 15.0e9 },
                .barium_ion => .{ .weight = 137.327, .density = 1.0, .fully_protonated_charge = 2, .log_p = -5.0, .hbd = 0, .state = .liquid, .delta_hf = -537.6, .heat_capacity = 30.0, .is_ion = true, .partial_molar_volume = -12.0 },
                .barium_sulfate => .{ .weight = 233.39, .density = 4.49, .log_p = -3.0, .hbd = 0, .hba = 4, .psa = 66.0, .state = .solid, .boiling_point = 1870.0, .melting_point = 1620.0, .water_solubility = 0.0000045, .delta_hf = -1473.2, .delta_hvap = 300.0, .delta_hfus = 38.0, .hildebrand = 25.0, .heat_capacity = 101.6, .color = .white, .color_intensity = 0.9, .bulk_modulus = 30.0e9 },
                .calcium_carbonate => .{ .weight = 100.086, .density = 2.71, .log_p = -2.12, .hbd = 0, .hba = 3, .psa = 63.19, .state = .solid, .melting_point = 1100.0, .water_solubility = 0.00013, .delta_hf = -1207.6, .delta_hfus = 36.0, .hildebrand = 25.0, .heat_capacity = 81.9, .color = .white, .color_intensity = 0.1, .bulk_modulus = 15.0e9 },
                .calcium_ion => .{ .weight = 40.078, .density = 1.55, .fully_protonated_charge = 2, .log_p = -2.5, .hbd = 0, .state = .solid, .melting_point = 1115.0, .boiling_point = 1757.0, .delta_hf = -542.8, .heat_capacity = 25.0, .is_ion = true, .partial_molar_volume = -17.8 },
                .carbon_dioxide => .{ .weight = 44.01, .density = 0.001799, .pka = &.{ 6.35, 10.33 }, .log_p = 0.0, .hbd = 0, .hba = 2, .state = .gas, .boiling_point = 194.7, .melting_point = 216.55, .water_solubility = 0.034, .delta_hf = -393.5, .delta_hvap = 16.7, .delta_hfus = 8.33, .heat_capacity = 37.11, .partial_molar_volume = 33.0 },
                .carbonate_ion => .{ .weight = 60.008, .density = 1.0, .fully_protonated_charge = 0, .pka = &.{ 6.35, 10.33 }, .log_p = -4.0, .hbd = 0, .hba = 3, .state = .solid, .water_solubility = 2.0, .delta_hf = -677.1, .heat_capacity = 50.0, .is_ion = true, .partial_molar_volume = -6.1 },
                .chloride_ion => .{ .weight = 35.453, .density = 1.56, .fully_protonated_charge = -1, .log_p = -3.5, .hbd = 0, .psa = 0, .state = .liquid, .delta_hf = -167.08, .gas_lipid_partition = 0.0, .heat_capacity = 25.0, .color = .transparent, .is_ion = true, .partial_molar_volume = 23.3 },
                .dichloromethane => .{ .weight = 84.93, .density = 1.322, .log_p = 1.2, .hbd = 0, .boiling_point = 312.8, .melting_point = 178.0, .delta_hf = 124.3, .delta_hvap = 28.06, .delta_hfus = 4.60, .heat_capacity = 100.0, .odor = .sweet, .odor_intensity = 0.7, .viscosity = 4.13e-4 },
                .disodium_sulfate => .{ .weight = 142.042, .density = 2.66, .log_p = -3.0, .hbd = 0, .hba = 4, .psa = 66.0, .state = .solid, .boiling_point = 1700.0, .melting_point = 1157.0, .water_solubility = 1.97, .delta_hf = -1387.08, .delta_hvap = 230.0, .delta_hfus = 24.0, .hildebrand = 25.0, .heat_capacity = 128.4, .color = .white, .color_intensity = 0.8, .bulk_modulus = 15.0e9 },
                .ethanol => .{ .weight = 46.07, .density = 0.79, .pka = &.{15.9}, .log_p = -0.31, .hbd = 1, .hba = 1, .boiling_point = 351.5, .melting_point = 159.0, .delta_hf = -277.6, .delta_hvap = 38.56, .delta_hfus = 4.93, .hildebrand = 26.5, .heat_capacity = 112.4, .odor = .ethereal, .odor_intensity = 0.4, .bulk_modulus = 1.1e9, .viscosity = 1.20e-3 },
                .graphite => .{ .weight = 12.011, .density = 2.26, .log_p = 0.0, .hbd = 0, .state = .solid, .melting_point = 3800.0, .water_solubility = 0.0, .delta_hf = 0.0, .delta_hfus = 117.0, .hildebrand = 0.0, .heat_capacity = 8.52, .color = .black, .color_intensity = 1.0, .odor = .none, .odor_intensity = 0.0, .bulk_modulus = 15.0e9 },
                .hydrogen_ion => .{ .weight = 1.008, .density = 1.0, .fully_protonated_charge = 1, .log_p = -6.0, .hbd = 1, .state = .gas, .heat_capacity = 10.0, .is_ion = true, .partial_molar_volume = 0.0 },
                .nitrogen => .{ .weight = 28.014, .density = 0.001145, .log_p = 0.0, .hbd = 0, .state = .gas, .boiling_point = 77.36, .melting_point = 63.15, .water_solubility = 0.0006, .delta_hf = 0.0, .delta_hvap = 5.56, .delta_hfus = 0.72, .heat_capacity = 29.12, .partial_molar_volume = 34.0 },
                .oxidane => .{ .weight = 18.015, .density = 0.9970, .log_p = -1.38, .hbd = 2, .hba = 1, .boiling_point = 373.13, .melting_point = 273.15, .delta_hf = -285.8, .delta_hvap = 40.65, .delta_hfus = 6.01, .hildebrand = 47.8, .heat_capacity = 75.38, .bulk_modulus = 2.2e9, .viscosity = 8.90e-4 },
                .oxygen => .{ .weight = 31.998, .density = 0.001308, .log_p = 0.0, .hbd = 0, .state = .gas, .boiling_point = 90.19, .melting_point = 54.36, .water_solubility = 0.0012, .delta_hf = 0.0, .delta_hvap = 6.82, .delta_hfus = 0.44, .heat_capacity = 29.38, .partial_molar_volume = 31.0 },
                .sodium_chloride => .{ .weight = 58.44, .density = 2.165, .log_p = -3.0, .hbd = 0, .psa = 0, .state = .solid, .boiling_point = 1686.0, .melting_point = 1074.0, .water_solubility = 6.15, .delta_hf = -411.12, .delta_hfus = 28.16, .hildebrand = 25.0, .gas_lipid_partition = 0.0, .delta_hvap = 207.0, .heat_capacity = 50.5, .color = .white, .color_intensity = 0.8, .bulk_modulus = 25.0e9 },
                .sodium_ion => .{ .weight = 22.990, .density = 0.968, .fully_protonated_charge = 1, .log_p = -3.5, .hbd = 0, .psa = 0, .state = .liquid, .delta_hf = -240.34, .gas_lipid_partition = 0.0, .heat_capacity = 25.0, .color = .transparent, .is_ion = true, .partial_molar_volume = -6.7 },
                .sulfate_ion => .{ .weight = 96.06, .density = 1.0, .fully_protonated_charge = -1, .pka = &.{1.99}, .log_p = -4.0, .hbd = 0, .hba = 4, .state = .liquid, .delta_hf = -909.3, .heat_capacity = 50.0, .is_ion = true, .partial_molar_volume = 14.0 },
            };
        }
