...
pub const MoleculeId = enum(u16) {
    ...
    pub inline fn molecule(this: MoleculeId) Molecule {
        return switch (this) {
            .acetate_ion => .{ .weight = 59.044, .density = 1.0, .fully_protonated_charge = -1, .pka = &.{4.76}, .log_p = -3.72, .hbd = 0, .hba = 2, .state = .solid, .water_solubility = 5.7, .delta_hf = -486.0, .heat_capacity = 80.0, .is_ion = true, .partial_molar_volume = 45.4 },
            ...
            .carbonate_ion => .{ .weight = 60.008, .density = 1.0, .fully_protonated_charge = -2, .pka = &.{ 6.35, 10.33 }, .log_p = -4.0, .hbd = 0, .hba = 3, .state = .solid, .water_solubility = 2.0, .delta_hf = -677.1, .heat_capacity = 50.0, .is_ion = true, .partial_molar_volume = -6.1 },
